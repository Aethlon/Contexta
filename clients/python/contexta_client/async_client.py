...
class Asynccontexta:
    ...
    async def restore(self, memory_id: str) -> Memory:
        data = await self._http._async_request(
            method="POST",
    ...
    async def delete(self, memory_id: str) -> None:
        await self._http._async_request(
            method="DELETE",
            endpoint=f"/memories/{memory_id}",
            is_write=True,
        )
    ...
    async def register_policy(
        ...
        data = await self._http._async_request(method="POST", endpoint="/policies", body=body, is_write=True)
        return Policy(**data)
    ...
    async def register_schema(
        ...
        data = await self._http._async_request(method="POST", endpoint="/schemas", body=body, is_write=True)
        return Schema(**data)

    async def ping(self) -> Dict[str, Any]:
        return await self._http._async_request(method="GET", endpoint="/healthz")
    ...
    async def create_session(
        ...
        if metadata:
            body["metadata"] = metadata
        data = await self._http._async_request(method="POST", endpoint="/sessions", body=body, is_write=True)
        return Session(**data)
