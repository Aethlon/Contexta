    ...
    <main className="flex min-h-screen items-center justify-center px-6">
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          {params.success ? (
            <div className="rounded-md border border-primary/30 bg-accent p-3 text-sm text-foreground">
              {params.success}
            </div>
          ) : null}
          ...
          <p className="text-sm text-muted-foreground">
            New here? <Link className="text-primary" href="/sign-up">Create an account</Link>
          </p>
        </CardContent>
      </Card>
    </main>
