...
# Force Celery into eager mode BEFORE any contexta import so tests never
# attempt to reach a Redis broker (settings are cached at first load).
os.environ["CONTEXTA_CELERY_TASK_ALWAYS_EAGER"] = "true"
os.environ["CONTEXTA_CELERY_BROKER_URL"] = "memory://"
os.environ["CONTEXTA_CELERY_RESULT_BACKEND"] = "cache+memory://"
