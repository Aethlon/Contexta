...
const AVAILABLE_SCOPES = [
  { id: "read", label: "Read", description: "Retrieve memories and context" },
  { id: "write", label: "Write", description: "Write observations" },
] as const;
...
export function ApiKeyManager({ initialKeys = [] }: { initialKeys?: ApiKey[] }) {
  ...
  const [selectedScopes, setSelectedScopes] = React.useState<string[]>(["read", "write"]);
  ...
  async function handleRevoke(keyId: string) {
    const ok = await revokeApiKeyAction(keyId);
    if (ok) {
